...
function MarketSnippet({ market, onOpen }) {
  ...
  return (
    <div className="snippet">
      ...
      <div className="ttl">3 fresh signals worth a 5-minute scan</div>
      <div className="body">D2C illustration spend up 34% YoY, comp band lifted, and a fresh point-of-view essay arguing the sans-serif-pastel template is dead.</div>
...
function RolesSnippet({ roles, onOpen }) {
  ...
  return (
    <div className="snippet">
      ...
      <div className="body">Talented, Pratham Books, and Codesign all index above 80% fit. Talented edges out with illustrator-first hiring.</div>
      <div className="snippet-mini-list">
        {sorted.map(r => (
